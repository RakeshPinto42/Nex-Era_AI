...
const WORKSPACES: Workspace[] = [
  ...
  { name: "Ledger", desc: "Commercial finance tools for pricing, forecasting, commissions and reporting.", href: "/ledger", cta: "Open Ledger", icon: LineChart, accent: "#0d9488" },
  ...
  return (
    <section id="workspaces" className="relative px-6 py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <h2 className="mx-auto mt-4 max-w-3xl text-center text-3xl font-semibold tracking-tight sm:text-4xl">
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <h3 className="mt-4 text-base font-semibold text-neutral-900">{w.name}</h3>
