...
export const AGENT_REGISTRY: AgentRegistration[] = [
  ...
  },
  {
    ...
    name: "File Agent",
    icon: "📁",
    description: "Reads, organizes and acts on files surfaced to it.",
    category: "Workspace",
    capabilities: ["file-read", "classification"],
    tools: ["files"],
    visibility: "internal",
    version: "0.1.0",
    health: "unknown",
  ...
  },
  {
    ...
    name: "Finance Agent",
    icon: "💹",
    description: "Drives pricing, forecasting and commission runs in Finance OS.",
    category: "Finance",
    capabilities: ["pricing", "forecasting", "commission"],
    tools: ["finance-os"],
    visibility: "public",
    version: "0.1.0",
    health: "unknown",
